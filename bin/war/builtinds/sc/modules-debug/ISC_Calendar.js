...
if (window.isc && isc.version != "v12.1p_2020-05-06/EVAL Deployment" && !isc.DevUtil) {
    ...
    eventDragCanvasDefaults: {
        ...
        dragRepositionStop : function () {
            ...
            if (cal.getEventStartDate(event).getTime() == cal.getEventStartDate(newEvent).getTime()) {
                // if the drop-date is the same as the event's current startDate, just ignore the drag
                return;
            }
