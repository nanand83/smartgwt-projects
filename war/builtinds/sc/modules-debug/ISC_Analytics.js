...
,isc.A._getChildFacetValues=function isc_CubeGrid__getChildFacetValues(parentFacetId,parentFacetValue,childFacetId,parentField,levelIndex){
    ...
    if(parentFacetId!=null){
        ...
        if(parentField!=null&&parentField.minimized!=null){
            ...
            minimized=parentFacetValue._defaultCollapsed;
        }
        if(minimized){
...
isc.evalBoundary;isc.B.push(isc.A._toggleOpenStateForField=function isc_CubeGrid__toggleOpenStateForField(field,isRow,desiredOpen){
    var toggleProperty=this.getToggleProperty(field),
...
isc.evalBoundary;isc.B.push(isc.A.chartLast=function isc_CubeGrid_chartLast(variableFacets,metricFacetValueId){
