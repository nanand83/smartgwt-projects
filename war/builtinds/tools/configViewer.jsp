...
<TITLE>Configuration Viewer | Isomorphic Software</TITLE>
</HEAD>
<BODY BGCOLOR='white' CLASS=normal>
<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=5 BORDER=0>
	<TR>
		<TD HEIGHT=125><a href="http://www.isomorphic.com"><IMG SRC="http://www.isomorphic.com/images/iso_top_logo.png" WIDTH="256" HEIGHT="100" ALT="Isomorphic Software Logo" border="0"></a></TD>
		<TD VALIGN=MIDDLE ALIGN=RIGHT><SPAN CLASS=pageHeader2>Isomorphic SmartClient SDK<BR>
		Configuration Viewer </SPAN><BR>
		</TD>
	</TR>
</TABLE>
